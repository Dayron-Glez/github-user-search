  ...
  const statCards = [
    {
      ...
      icon: (
        <svg width="18" height="18" viewBox="0 0 16 16" style={{ fill: '#fbbf24' }}>
    ...
    },
    {
      ...
      icon: (
        <svg width="18" height="18" viewBox="0 0 16 16" style={{ fill: 'var(--color-accent)' }}>
    ...
    },
    {
      ...
      icon: (
        <svg width="18" height="18" viewBox="0 0 16 16" style={{ fill: 'var(--color-accent-secondary)' }}>
    ...
    },
    {
      ...
      icon: (
        <svg width="18" height="18" viewBox="0 0 16 16" style={{ fill: 'var(--color-text-muted)' }}>
